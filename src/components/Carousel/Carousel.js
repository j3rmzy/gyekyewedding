    ...
    render() {
        return (
            <Carousel 
                ...
                <div><img alt="Michelle and Jermaine" src={IMG3} /></div>
                <div><img alt="Michelle and Jermaine" src={IMG4} /></div>
                ...
                <div><img alt="Michelle and Jermaine" src={IMG10} /></div>
                ...
                <div><img alt="Michelle and Jermaine" src={IMG15} /></div>
            </Carousel>
        )
    }
}
