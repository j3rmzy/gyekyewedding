                ...
                <Wrapper>
                    <div className="details-grid-container">
                        <div className="details-grid">
                            ...
                            <p>For a handful of the most popular local accommodation providers, please see the <a className="alternative-hotels" onClick={this.toggleModalHandler}>list</a>, otherwise, the most comprehensive and up to date list of establishments local to Elmore Court can found and downloaded in this PDF document: <a href="http://bit.ly/2laLad7" target="_blank">http://bit.ly/2laLad7</a></p>
                        </div>
